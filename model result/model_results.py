...
# this function convert all data in a dataframe into numeric values.
...
# this piece of code plot the total annual activity and total annual capacity of urban forms technologies for every regions
